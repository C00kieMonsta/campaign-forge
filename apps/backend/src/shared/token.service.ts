...
export class TokenService {
  ...
  appendFooter(html: string, emailLower: string): string {
    ...
    const footer = `
<div style="margin-top:40px;padding-top:20px;border-top:1px solid #e0e0e0;font-size:15px;color:#999;text-align:center;font-family:Arial,sans-serif">
  <p style="margin:0 0 6px 0"><strong style="color:#555;font-size:16px">Monique Pirson</strong><br>Belgium</p>
  <div style="margin: 15px 0;">
    <a href="mailto:monpirson@gmail.com" style="background-color: #558B2F; color: white; padding: 12px 24px; text-decoration: none; border-radius: 4px; font-weight: bold; display: inline-block; font-size:15px">Me contacter par email</a>
  </div>
