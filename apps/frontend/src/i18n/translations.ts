...
export const translations = {
  fr: {
    ...
    lex: {
      ...
      zoomIn: "Agrandir",
      zoomOut: "Réduire",
      mentionMenuLabel: "Fichiers du dossier",
      mentionHint: "Tapez @ pour citer un fichier du dossier",
      mentionMore: "autres fichiers, continuez à taper",
      mentionProcessing: "fichier(s) en cours de traitement",
      ...
      // ── Messages vocaux ──
      recordVoiceMessage: "Dicter un message",
      voiceMessage: "Message vocal",
      transcribing: "Transcription…",
      transcribeFailed: "Transcription impossible",
      discardRecording: "Supprimer l'enregistrement",
      removeVoiceMessage: "Retirer l'enregistrement",
      reviewTranscript: "Relire",
      sendRecording: "Envoyer",
      voiceDraftHint: "Corrigez la transcription avant d'envoyer.",
      voiceEmpty: "Rien n'a été enregistré.",
      voiceTooShort: "Enregistrement trop court.",
      voiceTooLarge:
        "Enregistrement trop volumineux pour être transcrit (max 25 Mo).",
      voiceNoSpeech: "Aucune parole reconnue. Écrivez le message ou réessayez.",
      playVoiceMessage: "Écouter",
      pauseVoiceMessage: "Pause",
      playbackFailed: "Lecture impossible",
      fileAsDocument: "Classer comme pièce",
      filedAsDocument: "Classé comme pièce",
      ...
      copy: "Copier",
      downloadSources: "Télécharger les pièces",
      ...
      selected: "sélectionné(s)",
      retry: "Réessayer",
      dismissTask: "Masquer ce panneau",
      ...
      pinned: "Épinglés",
      resizeDocuments: "Largeur du panneau des pièces",
      resizePinned: "Largeur du panneau épinglé",
  ...
  nl: {
    ...
    lex: {
      ...
      // ── "@"-vermelding van een bestand ──
      // ── Mobiel ──
      moreActions: "Meer acties",
      readingOptions: "Leesopties",
      done: "Klaar",
      zoomIn: "Vergroten",
      zoomOut: "Verkleinen",
      mentionMenuLabel: "Bestanden in het dossier",
      mentionHint: "Typ @ om een bestand uit het dossier te noemen",
      mentionMore: "andere bestanden, blijf typen",
      mentionProcessing: "bestand(en) worden nog verwerkt",
      addReference: "Refereren",
      addToChat: "Aan chat toevoegen",
      addedToChat: "Toegevoegd",
      ...
      // ── Spraakberichten ──
      recordVoiceMessage: "Een bericht inspreken",
      voiceMessage: "Spraakbericht",
      transcribing: "Transcriberen…",
      transcribeFailed: "Transcriptie mislukt",
      discardRecording: "Opname verwijderen",
      removeVoiceMessage: "Opname losmaken",
      reviewTranscript: "Nalezen",
      sendRecording: "Verzenden",
      voiceDraftHint: "Corrigeer de transcriptie voor u verzendt.",
      voiceEmpty: "Er is niets opgenomen.",
      voiceTooShort: "Opname te kort.",
      voiceTooLarge: "Opname te groot om te transcriberen (max 25 MB).",
      voiceNoSpeech: "Geen spraak herkend. Typ het bericht of probeer opnieuw.",
      playVoiceMessage: "Beluisteren",
      pauseVoiceMessage: "Pauzeren",
      playbackFailed: "Weergave mislukt",
      fileAsDocument: "Als stuk toevoegen",
      filedAsDocument: "Als stuk toegevoegd",
      ...
      copy: "Kopiëren",
      downloadSources: "Stukken downloaden",
      ...
      dismissTask: "Dit paneel verbergen",
      ...
      pinned: "Vastgezet",
      resizeDocuments: "Breedte van het documentenpaneel",
      resizePinned: "Breedte van het vastgezette paneel",
      resizeHint:
        "Sleep om de breedte aan te passen, dubbelklik om te herstellen",
